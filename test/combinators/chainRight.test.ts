...
import 'mocha';
import {chainRight, symbol, number, or, between, whitespace} from '../../lib';
...
describe('chainRight', () => {
  ...
  it('should use right associative application of operator functions', () => {
    const result = parser.parseText('1-2-3+2');
